...
import custom.CustomTableRendererSanpham;
...
public class PanelQuanlySanpham extends JPanel implements ActionListener, MouseListener {
	...
	private CustomJTextField tfTimMa;
	...
	private CustomJButton btnQLLSP;
	private CustomJButton btnQLNCC;
	private CustomJButton btnXoatrang;
	private CustomJButton btnLuu;
	private CustomJButton btnThem;
	private CustomJButton btnImport;
	...
	private CustomJLabel lblHinh;
	private CustomJLabel lblNgayNhap;
	private CustomJLabel lblTim;
	private CustomJLabel lblThemLoaiSp;
	private CustomJLabel lblThemNcc;
	private CustomJLabel lblTimThue;
	private CustomJLabel lblTimSoluongton;
...
//		pnlButton.add(btnXoa);
		...
		btnQLLSP = new CustomJButton("QL loại SP");
		...
		btnQLNCC = new CustomJButton("QL nhà cung cấp");
		...
		btnThem = new CustomJButton("Thêm");
		...
		btnImport = new CustomJButton("Nhập từ file Excel");
		...
		CustomJLabel lblTitle = new CustomJLabel("QUẢN LÝ SẢN PHẨM");
		...
		CustomJLabel lblThang = new CustomJLabel("t");
		...
		CustomJLabel lblGiaban = new CustomJLabel("Giá bán");
		lblGiaban.setBounds(298, 127, 90, 25);
		panelRight.add(lblGiaban);
		...
		CustomJLabel lblThuT = new CustomJLabel("Thuế từ");
		lblThuT.setBounds(671, 71, 148, 23);
		pnlTimKiem.add(lblThuT);

		CustomJLabel lblSLngTn = new CustomJLabel("Số lượng tồn từ");
		lblSLngTn.setBounds(671, 114, 148, 23);
		pnlTimKiem.add(lblSLngTn);

		CustomJLabel lblTimMa = new CustomJLabel("Tìm theo từ khóa");
		lblTimMa.setBounds(10, 25, 191, 23);
		pnlTimKiem.add(lblTimMa);

		CustomJLabel lblTimGiaban = new CustomJLabel("Giá bán từ");
		...
		lblThemLoaiSp = new CustomJLabel("");
		...
		lblTimSoluongton = new CustomJLabel("");
		...
		CustomJButton btnChonhinh = new CustomJButton("Chọn hình");
...
//					bg_img = new ImageIcon(temp_img);
		...
		tfDonvitinh.setBounds(413, 338, 145, 25);
		...
		tfMausac.setBounds(413, 285, 145, 25);
		...
		tfSoluongton.setModel(new SpinnerNumberModel(Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(10000),
				Integer.valueOf(5)));
		tfSoluongton.setBounds(325, 485, 60, 25);
		...
		tfThue.setBounds(498, 485, 60, 25);
		...
		tfGiamua.setBounds(123, 127, 165, 25);
		...
		tfGiaban.setModel(new SpinnerNumberModel(Double.valueOf(0.d), Double.valueOf(0.d), Double.valueOf(1000000000),
				Double.valueOf(10000)));
		tfGiaban.setBounds(363, 127, 160, 25);
		...
		CustomTableRendererSanpham renderTableSanpham = new CustomTableRendererSanpham();
		...
		CustomJScrollPane scrollSP = new CustomJScrollPane(table, vertical_always, horizontal_always);
		scrollSP.setBounds(10, 15, 1042, 636);
		pnlMain.add(scrollSP);
		add(pnlMain);

		CustomJScrollPane scrollPane = new CustomJScrollPane(tfMoTa);
...
//		panel_phantrang = new JPanel();
	...
	public void reloadTable() {
		...
		new PlaceHolder(tfTimMa, new Color(192, 192, 192), Color.BLACK,
				"Nhập mã, tên, mô tả, màu sắc hoặc thương hiệu của sản phẩm", false, this.getFont().toString(), 16);
		decorator.reload();
	}
	...
	private boolean validInputTextField() {
		...
		if (Integer.parseInt(tfSoluongton.getValue().toString()) <= 0) {
			JOptionPane.showMessageDialog(this, "Vui lòng nhập số lượng tồn của sản phẩm", "Thông báo",
					JOptionPane.ERROR_MESSAGE);
			return false;
		}
		if (Float.parseFloat(tfThue.getValue().toString()) <= 0) {
			JOptionPane.showMessageDialog(this, "Vui lòng nhập thuế của sản phẩm", "Thông báo",
					JOptionPane.ERROR_MESSAGE);
			return false;
		}
		return true;
