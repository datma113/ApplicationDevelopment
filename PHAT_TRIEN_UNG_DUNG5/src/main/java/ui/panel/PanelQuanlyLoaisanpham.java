...
public class PanelQuanlyLoaisanpham extends JPanel implements ActionListener, MouseListener {
	...
	private CustomJTextField tfTenLsp;
	private CustomJTextField tfMaLsp;
	...
	public PanelQuanlyLoaisanpham() {
		...
		CustomJLabel lblTitle = new CustomJLabel("DANH MỤC LOẠI SẢN PHẨM");
		...
		CustomJLabel lblTenSp = new CustomJLabel("Tên Loại SP");
		lblTenSp.setBounds(10, 84, 163, 25);
		add(lblTenSp);

		CustomJLabel lblMH = new CustomJLabel("Mã Loại SP");
		lblMH.setBounds(10, 46, 163, 25);
		add(lblMH);

		tfTenLsp = new CustomJTextField("");
		tfTenLsp.setBounds(144, 82, 630, 25);
		add(tfTenLsp);

		tfMaLsp = new CustomJTextField(20);
