...
public class PanelQuanlyKhachhang extends JPanel implements ActionListener, MouseListener {
	...
	private CustomJTextField tfMakh;
	...
	public PanelQuanlyKhachhang() {
		 ...
		 * label
		 */
		CustomJLabel lblTitle = new CustomJLabel("QUẢN LÝ KHÁCH HÀNG");
		...
		CustomJLabel lblMa = new CustomJLabel("Mã KH (*)");
		lblMa.setBounds(10, 15, 142, 25);
		panelMain.add(lblMa);

		CustomJLabel lblHo = new CustomJLabel("Họ Tên (*)");
		 ...
		 * textfield
		 */
		tfMakh = new CustomJTextField(20);
		...
		btnThem.setBounds(1460, 9, 170, 35);
...
//		pnlButton.add(btnXoa);
		 ...
		 * jscrollpane
		 */
		CustomJScrollPane scrollKH = new CustomJScrollPane(table, vertical_always, horizoltal_always);
...
//		resizeColumnsKH();
	...
	public void them() {
		 ...
		 */
		frame.dispose();
		Khachhang kh = panelThemkhachhang.getKh();
		if (kh != null) {
	...
	public void timTheoMa() {
		String keyword = tfTimMa.getText();
