...
public class PanelQuanlyNhacungcap extends JPanel implements ActionListener, MouseListener {
	...
	private CustomJTextField tfMaNcc;
	private CustomJTextField tfTenNcc;
	...
	public PanelQuanlyNhacungcap() {
		...
		CustomJLabel lblTitle = new CustomJLabel("QUẢN LÝ NHÀ CUNG CẤP SẢN PHẨM");
		...
		CustomJLabel lblEmail = new CustomJLabel("Email");
		...
		CustomJLabel lblMaNcc = new CustomJLabel("Mã NCC");
		lblMaNcc.setBounds(10, 43, 142, 25);
		add(lblMaNcc);

		CustomJLabel lblTenNcc = new CustomJLabel("Tên NCC");
		lblTenNcc.setBounds(10, 87, 142, 25);
		add(lblTenNcc);

		tfEmail = new CustomJTextField(20);
		...
		tfMaNcc = new CustomJTextField("");
		tfMaNcc.setBounds(108, 43, 390, 25);
		tfMaNcc.setEditable(false);
		add(tfMaNcc);

		tfTenNcc = new CustomJTextField(20);
...
//		pnlButton.add(btnXoa);
		...
		CustomJScrollPane scrollPane = new CustomJScrollPane(table, vertical_always, horizontal_needed);
