...
public class PanelQuanlyNhanvien extends JPanel implements ActionListener, MouseListener, ItemListener {
	...
	private CustomJTextField tfManv;
	private CustomJTextField tfHo;
	...
	private CustomJTextField tfSocmnd;

	private CustomJButton btnTim;
	private CustomJButton btnThem;
	private CustomJButton btnXoa;
	private CustomJButton btnLuu;
	private CustomJButton btnQLTK;
	...
	private CustomJLabel lblPicture;
	private CustomJLabel lblNewLabel;
	...
	public PanelQuanlyNhanvien() {
		...
		CustomJLabel lblMa = new CustomJLabel("Mã NV (*)");
		lblMa.setBounds(168, 20, 142, 25);
		pnlMain.add(lblMa);

		CustomJLabel lblHo = new CustomJLabel("Họ (*)");
		lblHo.setBounds(168, 69, 142, 25);
		pnlMain.add(lblHo);

		CustomJLabel lblTen = new CustomJLabel("Tên (*)");
		lblTen.setBounds(648, 69, 145, 25);
		pnlMain.add(lblTen);

		CustomJLabel lblNgaySinh = new CustomJLabel("Ngày sinh");
		lblNgaySinh.setBounds(1137, 68, 125, 25);
		pnlMain.add(lblNgaySinh);

		CustomJLabel lblDiaChi = new CustomJLabel("Địa chỉ");
		lblDiaChi.setBounds(168, 118, 142, 25);
		pnlMain.add(lblDiaChi);

		CustomJLabel lblSdt = new CustomJLabel("SĐT");
		lblSdt.setBounds(648, 20, 145, 25);
		pnlMain.add(lblSdt);

		CustomJLabel lblCmnd = new CustomJLabel("Số CMND");
...
//		pnlButton.add(btnXoa);
		...
		lblNewLabel = new CustomJLabel("Tìm theo từ khóa");
		...
		CustomJScrollPane scrollNV = new CustomJScrollPane(table, vertical_always, horizontal_needed);
...
//		panel_phantrang = new JPanel();
	 ...
	 */
	public void tim() {
		String keyword = tfTimMa.getText().trim();
	...
	private boolean validInputTextField() {
		...
		if (tfSocmnd.getText().trim().equals("")) {
			JOptionPane.showMessageDialog(this, "Số CMND không được để trống", "Thông báo", JOptionPane.ERROR_MESSAGE);
