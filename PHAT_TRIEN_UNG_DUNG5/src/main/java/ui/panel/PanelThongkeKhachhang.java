...
public class PanelThongkeKhachhang extends JPanel {
	...
	public PanelThongkeKhachhang() {
		...
		CustomJLabel lblNam = new CustomJLabel("Chọn thời gian");
		...
		CustomJButton btnXem = new CustomJButton("Xem");
		...
		btnXem.addActionListener(e -> reloadChar());
		pnlMain.add(btnXem);
	 ...
	 * @return
	 */
	public boolean writeExcel(Map<Khachhang, Double> map, String excelFilePath) {
	...
	private Workbook getWorkbook(String excelFilePath) {
		...
		if (excelFilePath.endsWith("xlsx")) {
			...
			JOptionPane.showMessageDialog(null,
					"File không đúng định dạng. Vui lòng đặt lại tên file. Tên file phải kết thúc bằng .xls hoặc .xlsx","Xuất File Excel", JOptionPane.ERROR_MESSAGE);
		}
		return workbook;
	}
