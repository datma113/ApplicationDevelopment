...
public class FrameDoimatkhau {
	...
	public FrameDoimatkhau(Nhanvien nv) {
		...
		lblMess = new CustomJLabel("\n");
		tfTenDN.setText(nv.getManhanvien());
		tfTenDN.setEditable(false);
		Object[] obj = { new CustomJLabel("Tên Đăng Nhập :"), tfTenDN, new CustomJLabel("Mật Khẩu mới :"), tfMKmoi,
				new CustomJLabel("Xác Nhận Mật Khẩu Mới :"), tfConfirmMKmoi, lblMess };
