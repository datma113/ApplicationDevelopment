...
import custom.CustomJPanel;
import custom.CustomJPassField;
import custom.CustomJTextField;
import dao.DaoTaikhoan;
import entity.Nhanvien;
import entity.Taikhoan;
import ui.panel.PanelPhuchoi;

public class FrameDangnhap extends JFrame implements ActionListener {

	private static final long serialVersionUID = 1L;

	private CustomJTextField tfUser;
	private CustomJPassField tfPass;
	private CustomJButton btnDangNhap;
	private CustomJButton btnThoat;
	...
	public FrameDangnhap() {
		...
		CustomJLabel lblPhuchoi = new CustomJLabel("Phục hồi dữ liệu");
		...
		tfUser = new CustomJTextField("NV00000001");
		tfPass = new CustomJPassField("123");
		btnDangNhap = new CustomJButton("Đăng nhập");
		btnThoat = new CustomJButton("Thoát");

		CustomJPanel p = new CustomJPanel();
		p.setLayout(null);
		...
		CustomJLabel lblDangNhap = new CustomJLabel("Đăng Nhập");
		...
		CustomJLabel lblUser = new CustomJLabel("Tên TK");
		lblUser.setBounds(40, 75, 117, 25);
		p.add(lblUser);

		CustomJLabel lblpass = new CustomJLabel("Mật Khẩu");
		lblpass.setBounds(40, 125, 117, 25);
		p.add(lblpass);

		CustomJLabel lblTitle1 = new CustomJLabel("HỆ THỐNG QUẢN LÝ CỬA HÀNG BÁN");
		...
		CustomJLabel lblTitle2 = new CustomJLabel("LINH KIỆN MÁY VI TÍNH THÀNH ĐẠT");
