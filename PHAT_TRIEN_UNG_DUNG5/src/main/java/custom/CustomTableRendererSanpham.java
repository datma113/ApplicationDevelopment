...
public class CustomTableRendererSanpham implements TableCellRenderer {
	...
	private static final int INDEX_SOLUONGTON = 6;
	private static final int INDEX_NGUNGKINHDOANH = 18;
