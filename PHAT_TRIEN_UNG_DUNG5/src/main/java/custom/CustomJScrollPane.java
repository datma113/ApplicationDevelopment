...
public class CustomJScrollPane extends JScrollPane {
	...
	public CustomJScrollPane(int vsbPolicy, int hsbPolicy) {
		this(null, vsbPolicy, hsbPolicy);
	}

	public CustomJScrollPane(Component view, int vsbPolicy, int hsbPolicy) {
	...
	private static class ModernScrollBarUI extends BasicScrollBarUI {
		...
		public ModernScrollBarUI(CustomJScrollPane sp) {
			this.sp = sp;
		}
